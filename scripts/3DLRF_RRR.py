'''
CONFIG FILES= /../datasets/3D models/Cvlab/Kinect/ObjectRecognition/Scenes/2011_06_27/configwithbestview

From configwithbestview folder, read all Configscene00xx.ini files
Check MODEL_0, PATH, MODEL_0_GROUNDTRUTH 

Send as arguments to ./../build/3DLRF_RRR
'''
...
#			print path_set
			...
			if model_0_set:
				...
				call(["../build/3DLRF_RRR", MODEL_0, PATH, MODEL_0_GROUNDTRUTH])
				model_0_set = 0
				print count
			print MODEL_1
			...
			if model_1_set:
				count+=1	
				call(["../build/3DLRF_RRR", MODEL_1, PATH, MODEL_1_GROUNDTRUTH])
				model_1_set = 0
				print count
			print MODEL_2
			...
			if model_2_set:
				count+=1
				call(["../build/3DLRF_RRR", MODEL_2, PATH, MODEL_2_GROUNDTRUTH])
				model_2_set = 0
				print count
			print MODEL_3
			...
			if model_3_set:
				count+=1
				call(["../build/3DLRF_RRR", MODEL_3, PATH, MODEL_3_GROUNDTRUTH])
				model_3_set = 0
				print count
		except:
			pass
