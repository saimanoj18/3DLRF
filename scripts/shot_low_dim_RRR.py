...
#				call(["/home/sai/pcl_testing/pami_feature/build/bshot_shot_for_PATCH3D", MODEL_0, PATH, MODEL_0_GROUNDTRUTH])
				call(["../build/shot_low_dim", MODEL_0, PATH, MODEL_0_GROUNDTRUTH])
				model_0_set = 0
				print count
			print MODEL_1
			...
			if model_1_set:
				count+=1	
				call(["../build/shot_low_dim", MODEL_1, PATH, MODEL_1_GROUNDTRUTH])
				model_1_set = 0
				print count
			print MODEL_2
			...
			if model_2_set:
				count+=1
				call(["../build/shot_low_dim", MODEL_2, PATH, MODEL_2_GROUNDTRUTH])
				model_2_set = 0
				print count
			print MODEL_3
			...
			if model_3_set:
				count+=1
				call(["../build/shot_low_dim", MODEL_3, PATH, MODEL_3_GROUNDTRUTH])
				model_3_set = 0
				print count
		except:
			pass
